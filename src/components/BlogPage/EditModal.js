...
{diseaseList.map((lan) => {
      ...
      >
        ...
        <Modal.Body>  
        <h2 className="cols_main-title cols_main-title--top container">PLEASE READ THESE TERMS AND CONDITIONS OF USE CAREFULLY BEFORE USING THIS SITE.</h2><br/>
...
<h2 className="cols_main-title cols_main-title--top container">The Site Does Not Provide Medical Advice</h2>
...
<h2 className="cols_main-title cols_main-title--top container">Children's Privacy</h2>
...
<h2 className="cols_main-title cols_main-title--top container">Use of the Content</h2>
...
<h2 className="cols_main-title cols_main-title--top container">Liability of All-cures.com and Its Licensors</h2>
...
<h2 className="cols_main-title cols_main-title--top container">User Content and Submissions</h2>
...
<h2 className="cols_main-title cols_main-title--top container">User Submissions — Image, Video, Audio Files</h2>
...
<h2 className="cols_main-title cols_main-title--top container">Passwords</h2>
...
<h2 className="cols_main-title cols_main-title--top container">Advertisements, Searches, and Links to Other Sites</h2>
...
<h2 className="cols_main-title cols_main-title--top container">Jurisdiction</h2>
...
<h2 className="cols_main-title cols_main-title--top container">Complete Agreement</h2>
...
<h2 className="cols_main-title cols_main-title--top container">Thank you for your cooperation. We hope you find the All-cures.com Site helpful and convenient to use! </h2>
      ...
      >
        ...
        <Modal.Body>  
        <h2 className="cols_main-title cols_main-title--top container">Introduction</h2>
...
<h2 className="cols_main-title cols_main-title--top" container >Definitions</h2>
...
<h2 className="cols_main-title cols_main-title--top container" >Information Collection and Use</h2>
...
<h2 className="cols_main-title cols_main-title--top container">Types of Data Collected</h2>
...
<h2 className="cols_main-title cols_main-title--top container">Transfer of Data</h2>
...
<h2 className="cols_main-title cols_main-title--top container">Disclosure of Data</h2>
<p className='p1 container'>We may disclose personal information that we collect, or you provide.</p><br/>
<h2 className="cols_main-title cols_main-title--top container">Disclosure for Law Enforcement.</h2>
...
<h2 className="cols_main-title cols_main-title--top container">Business Transaction.</h2>
...
<h2 className="cols_main-title cols_main-title--top container">Service Providers</h2>
...
<h2 className="cols_main-title cols_main-title--top container">Analytics</h2>
...
<h2 className="cols_main-title cols_main-title--top container">Changes to This Privacy Policy</h2>
...
<h2 className="cols_main-title cols_main-title--top container">Contact Us</h2>
